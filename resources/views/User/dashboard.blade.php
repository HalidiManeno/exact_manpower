                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="text-right py-0 align-middle">
                                      ...
                                      <a href="#" class="btn btn-warning" data-id="'.$data->id.'" data-toggle="modal" data-target="#modal-admin_update{{ $user_data->id }}"><i class="fas fa-pen"></i></a> 
                                      <a  id="deletepuser" data-id="'.$data->id.'"  href="/delete-user'.$data->id.'" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                      </div>
                                     </td>'
                                </tr>
                              @endforeach
